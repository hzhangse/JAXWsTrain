 ...
 * 
 */
@WebServiceClient(name = "OrderProcess", targetNamespace = "http://jawxs.tutorial/jaxws/orderprocess", wsdlLocation = "http://localhost:8080/OrderProcessWeb/orderprocess?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERPROCESS_QNAME = new QName("http://jawxs.tutorial/jaxws/orderprocess", "OrderProcess");
    ...
    public OrderProcessService getOrderProcessPort() {
        return super.getPort(new QName("http://jawxs.tutorial/jaxws/orderprocess", "OrderProcessPort"), OrderProcessService.class);
    }
    ...
    public OrderProcessService getOrderProcessPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jawxs.tutorial/jaxws/orderprocess", "OrderProcessPort"), OrderProcessService.class, features);
    }
