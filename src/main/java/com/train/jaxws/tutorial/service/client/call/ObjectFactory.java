 ...
 * generated in the com.train.jaxws.tutorial.service.client.call package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessOrder_QNAME = new QName("http://jawxs.tutorial/jaxws/orderprocess", "processOrder");
    private final static QName _ProcessOrderResponse_QNAME = new QName("http://jawxs.tutorial/jaxws/orderprocess", "processOrderResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.train.jaxws.tutorial.service.client.call
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jawxs.tutorial/jaxws/orderprocess", name = "processOrder")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jawxs.tutorial/jaxws/orderprocess", name = "processOrderResponse")
